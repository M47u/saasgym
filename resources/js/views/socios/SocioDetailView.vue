                    ...
                    <div v-else-if="tab === 'info'">
                        <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-5">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <dd v-if="socio.plan" class="flex items-center gap-3">
                                    <div class="flex items-center gap-2 px-3 py-2 rounded-lg bg-violet-50 border border-violet-100">
                                        ...
                                        <span v-if="socio.plan.precio !== null" class="text-sm text-violet-600">
                                            — ${{ Number(socio.plan.precio).toLocaleString('es-AR') }}
                                        </span>
                                    </div>
